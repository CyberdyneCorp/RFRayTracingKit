...
The library SHALL determine the in-foliage segment length of a path from geometry tagged as
vegetation (a vegetation material or a vegetation volume) and apply the foliage loss for that
depth.

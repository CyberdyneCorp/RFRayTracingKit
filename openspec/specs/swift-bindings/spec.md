# swift-bindings Specification

## Purpose
An idiomatic SwiftPM package over the C API (librftrace_c): value types, throwing error handling, and RAII, with no raw pointers in the public surface. Authored to the C ABI; verified where a Swift toolchain and the built C library exist.
## Requirements
